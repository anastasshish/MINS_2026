...
import ru.bmstu.service.ReferenceCatalogGateway;
...
import ru.bmstu.promo.WednesdaySparePartsPromoPreview;
...
public class ConsoleMenu {
    ...
    public ConsoleMenu(
            ...
            ReferenceCatalogGateway referenceCatalogGateway,
    ...
    public void start() {
        ...
        while (running) {
            ...
            ServiceLog.info(SERVICE_NAME, "Начата обработка пользовательской команды: " + choice);
            ...
            try {
                ...
                ServiceLog.info(SERVICE_NAME, "Обработка команды завершена");
                TraceContext.clear();
            }
    ...
    private void addPartToInventory() {
        ...
        Part part = referenceCatalogGateway.createPart(name, price, quantity);
    ...
    private void showAllParts() {
        List<Part> parts = referenceCatalogGateway.getAllParts();
    ...
    private void printOrder(RepairOrder order) {
        ...
        //System.out.println("Промо-оценка: " + WednesdaySparePartsPromoPreview.buildPromoHintForOrder(order));
    ...
    private void showFridayPromoPreview() {
        ...
        System.out.println(WednesdaySparePartsPromoPreview.buildPromoHintForOrder(order));
    }
